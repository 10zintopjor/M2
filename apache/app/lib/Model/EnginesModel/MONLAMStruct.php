 ...
 *
 */
class EnginesModel_MONLAMStruct extends EnginesModel_EngineStruct {

    /**
     * @var string
     */
    public $description = "Monlam Engine";
     ...
     * @var string
     */
    public $class_load = Constants_Engines::MONLAM;
    ...
    public static function getStruct() {
        return new EnginesModel_MONLAMStruct();
    }
